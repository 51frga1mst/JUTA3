...
//dieser Klasse ausfРЎРЉhren. Р В¦ffnen Sie die damit erzeugte 
//Datei "index.html" in Ihrem Browser

/** Klassenmethoden zur einfachen Eingabe und Erzeugung von Daten in java.
 * Die Daten kРЎвЂ nnen entweder РЎРЉber die Tastatur eingegeben oder
 * zufР Т‘llig generiert werden. <p>
 * Bisher werden die folgenden, primitiven Datentypen unterstРЎРЉtzt:
...
public class Input {
	...
	/**
	 * Leitet die Eingabe fРЎРЉr die РЎРЉbergebenen Parameter um. Nachdem 
	 ...
	 * an den LeerrР Т‘umen in Teilstrings. Die Eingabe wird durch &lt;return&gt; beendet.
	 * @param prompt Stellt einen Text vor die Eingabe.
	...
	/**
	 * Erzeugt einen zufР Т‘lligen <tt>int</tt>-Wert.
	...
	public static int randomInt(int von, int bis){
		...
		int ergebnis = bis - zahl;				// zurРЎРЉck transformieren
		return ergebnis;
	}

	/**
	 * Erzeugt einen zufР Т‘llig besetzen <tt>int</tt>-Vektor mit der vorgegebenen LР Т‘nge.
	 * @param laenge die LР Т‘nge des zu erzeugenden Vektors
	...
	/**
	 * Erzeugt einen zufР Т‘lligen <tt>long</tt>-Wert.
	 * @param von untere Grenze
	 * @param bis obere Grenze
	 * @return Der erzeugte Wert
	 */
	public static long randomLong(long von, long bis){
		...
		long ergebnis = bis - zahl;				// zurРЎРЉck transformieren
		return ergebnis;
	}

	/**
	 * Erzeugt einen zufР Т‘llig besetzen <tt>long</tt>-Vektor mit der vorgegebenen LР Т‘nge.
	 * @param laenge die LР Т‘nge des zu erzeugenden Vektors
	 * @param von untere Grenze der Zufallszahlen
	 * @param bis obere Grenze der Zufallszahlen
	 * @return Der erzeugte Vektor
	...
	/**
	 * Erzeugt einen zufР Т‘lligen <tt>float</tt>-Wert.
	 * @param von untere Grenze
	 * @param bis obere Grenze
	 * @return Der erzeugte Wert
	 */
	...
	/**
	 * Erzeugt einen zufР Т‘llig besetzen <tt>float</tt>-Vektor mit der vorgegebenen LР Т‘nge.
	 * @param laenge die LР Т‘nge des zu erzeugenden Vektors
	 * @param von untere Grenze der Zufallszahlen
	 * @param bis obere Grenze der Zufallszahlen
	 * @return Der erzeugte Vektor
	...
	/**
	 * Erzeugt einen zufР Т‘lligen <tt>double</tt>-Wert.
	 * @param von untere Grenze
	 * @param bis obere Grenze
	 * @return Der erzeugte Wert
	 */
	...
	/**
	 * Erzeugt einen zufР Т‘llig besetzen <tt>double</tt>-Vektor mit der vorgegebenen LР Т‘nge.
	 * @param laenge die LР Т‘nge des zu erzeugenden Vektors
	 * @param von untere Grenze der Zufallszahlen
	 * @param bis obere Grenze der Zufallszahlen
	 * @return Der erzeugte Vektor
	 ...
	 * String lР Т‘nger als ein Zeichen, wird eine Exception ausgelРЎвЂ st.
	 */
	...
	/**
	 * Erzeugt einen zufР Т‘lligen <tt>char</tt>-Wert zwischen ASCII(33) und ASCII(127).
	...
	/**
	 * Erzeugt einen zufР Т‘llig besetzen <tt>char</tt>-Vektor mit der vorgegebenen LР Т‘nge.
	 ...
	 * MРЎвЂ gliche Eingaben sind <tt>t</tt>, <tt>true</tt>, <tt>f</tt>, 
	 * oder <tt>false</tt> (unabhР Т‘ngig von GroР Р‡- und Kleinschreibung).
	 */
	 ...
	 * Boolsche Werte kРЎвЂ nnen durch <tt>t</tt>, <tt>true</tt>, <tt>f</tt>, 
	 * oder <tt>false</tt> (unabhР Т‘ngig
	 * von GroР Р‡- und Kleinschreibung) eingegeben werden.
	 * Die Eingabe wird durch &lt;return&gt; beendet.
	 * @return Der eingelesene Wert
	 */
	...
	/**
	 * Erzeugt einen zufР Т‘lligen <tt>boolean</tt>-Wert.
	 * @return Der erzeugte Wert
	 */
	...
	/**
	 * Erzeugt einen zufР Т‘llig besetzten <tt>booelan</tt>-Vektor mit der vorgegebenen LР Т‘nge.
	 * @param laenge die LР Т‘nge des zu erzeugenden Vektors
	 * @return Der erzeugte Vektor
	 */
